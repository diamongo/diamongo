...
abstract class CliCommand {
    ...
    @Option(name = {"--mongo-uri", "-uri"}, description = "The MongoDB uri")
    public String uri = "mongodb://localhost";
