...
@MigrationMarker
public class V2_0__TestChangeSet implements MongoDatabaseMigration {

    private static final Logger LOGGER = LoggerFactory.getLogger(V2_0__TestChangeSet.class);
